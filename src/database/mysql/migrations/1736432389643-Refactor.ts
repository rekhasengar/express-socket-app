...
export class Refactor1736432389643 implements MigrationInterface {
    name = 'Refactor1736432389643'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE \`socket\` (\`key\` int NOT NULL AUTO_INCREMENT, \`id\` varchar(36) NOT NULL, \`createAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updateAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`deleted\` tinyint NOT NULL DEFAULT 0, \`socketId\` varchar(255) NOT NULL, \`userKey\` int NOT NULL, \`conversationKey\` int NOT NULL, UNIQUE INDEX \`IDX_54469a3174932555576d81bd65\` (\`id\`), UNIQUE INDEX \`REL_78df0073f4afedb6c8f5871bd0\` (\`userKey\`), PRIMARY KEY (\`key\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`users\` (\`key\` int NOT NULL AUTO_INCREMENT, \`id\` varchar(36) NOT NULL, \`createAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updateAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`deleted\` tinyint NOT NULL DEFAULT 0, \`firstName\` varchar(255) NOT NULL, \`lastName\` varchar(255) NOT NULL, \`email\` varchar(255) NOT NULL, \`password\` varchar(255) NOT NULL, \`isVerified\` bit NOT NULL DEFAULT 0, \`resetPasswordToken\` text NULL, \`refreshToken\` text NULL, \`emailVerificationToken\` text NULL, \`isLoginEnabled\` bit NOT NULL DEFAULT 0, \`socketKey\` int NULL, UNIQUE INDEX \`IDX_a3ffb1c0c8416b9fc6f907b743\` (\`id\`), UNIQUE INDEX \`IDX_97672ac88f789774dd47f7c8be\` (\`email\`), UNIQUE INDEX \`REL_ea7ec2940e564d47671c26ae16\` (\`socketKey\`), PRIMARY KEY (\`key\`)) ENGINE=InnoDB`);
        ...
        await queryRunner.query(`ALTER TABLE \`socket\` ADD CONSTRAINT \`FK_88aa68fc52e999003572f87491c\` FOREIGN KEY (\`conversationKey\`) REFERENCES \`conversations\`(\`key\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE \`users\` ADD CONSTRAINT \`FK_ea7ec2940e564d47671c26ae160\` FOREIGN KEY (\`socketKey\`) REFERENCES \`socket\`(\`key\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`users\` DROP FOREIGN KEY \`FK_ea7ec2940e564d47671c26ae160\``);
        await queryRunner.query(`ALTER TABLE \`socket\` DROP FOREIGN KEY \`FK_88aa68fc52e999003572f87491c\``);
        ...
        await queryRunner.query(`DROP INDEX \`REL_ea7ec2940e564d47671c26ae16\` ON \`users\``);
        await queryRunner.query(`DROP INDEX \`IDX_97672ac88f789774dd47f7c8be\` ON \`users\``);
        await queryRunner.query(`DROP INDEX \`IDX_a3ffb1c0c8416b9fc6f907b743\` ON \`users\``);
        await queryRunner.query(`DROP TABLE \`users\``);
        await queryRunner.query(`DROP INDEX \`REL_78df0073f4afedb6c8f5871bd0\` ON \`socket\``);
