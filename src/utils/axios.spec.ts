...
describe('axois request', () => {
  ...
  it('axios post request run successfully', async () => {
    nock(basePath).post(fakeUrl).reply(200, {
      data: {},
      status: 200,
      statusText: 'OK',
      headers: {},
  ...
  it('axios put request run successfully', async () => {
    nock('https://anyurl.com').put('/postdata').reply(200, {
      data: {},
      status: 200,
      statusText: null,
      headers: {},
  ...
  it('axios delete request run successfully', async () => {
    nock('https://anyurl.com').delete('/postdata').reply(200, {
      data: {},
      status: 200,
      statusText: null,
      headers: {},
  ...
  it('axios request return not found', async () => {
    nock('https://anyurl.com').get('/getdata').reply(404);
    await expect(axiosUtils.getRequest('https://anyurl.com/getdata', {})).rejects.toThrow(
